...
//        builder.target(new LatLng(40.056865, 116.307766));
        builder.target(new LatLng(28.431701, 109.439123));
        builder.zoom(11.0f);
...
//        LatLng llA = new LatLng(40.263175, 116.200244);
        ...
        LatLng llB = new LatLng(28.631701, 109.439123);

        OverlayOptions  markerOptions1 = new MarkerOptions().flat(true).anchor(0.5f, 0.5f)
                .icon(BitmapDescriptorFactory.fromResource(R.mipmap.icon_st)).position(polylines.get(0));
        Marker mMarkerA = (Marker) (mBaiduMap.addOverlay(markerOptions1));
       OverlayOptions  markerOptions2 = new MarkerOptions().flat(true).anchor(0.5f, 0.5f)
                .icon(BitmapDescriptorFactory.fromResource(R.mipmap.icon_en)).position(llB);
        Marker mMarkerB = (Marker) (mBaiduMap.addOverlay(markerOptions2));
    }
...
//            }
    ...
    private static final LatLng[] latlngs = new LatLng[]{
            new LatLng(28.013626, 109.518875),
            new LatLng(28.431701, 109.439123),
...
//    private static final LatLng[] latlngs = new LatLng[]{
//            new LatLng(28.013626, 109.518875),
//            new LatLng(28.013626, 109.508875),
//            new LatLng(28.013626, 109.498875),
//            new LatLng(28.013626, 109.488875),
//            new LatLng(28.013626, 109.478875),
//            new LatLng(28.013626, 109.468875),
//            new LatLng(28.013626, 109.459123),
//            new LatLng(28.013626, 109.449123),
//            new LatLng(28.431701, 109.439123),
////            new LatLng(40.058022, 116.307693),
////            new LatLng(40.058029, 116.307590),
////            new LatLng(40.057913, 116.307119),
