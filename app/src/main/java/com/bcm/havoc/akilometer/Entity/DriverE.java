...
public class DriverE implements Serializable {
    public DriverE() {
    }

    public DriverE(String id, String carNumber, String plateNumber, String driverName, String telephone, String carType, String sendType, String startPosition, String endPosition, String idCard, String bank, String bankAccount, String inviter, String drivingYears, String cooperationNum) {
        Id = id;
        CarNumber = carNumber;
